package mx.ita.daytoday.Perfil;
...
import mx.ita.daytoday.menuPrincipal;
...
public class Perfil_Usuario extends AppCompatActivity {
    ...
    EditText Nombres_Perfil, Apellidos_Perfil, Edad_Perfil,
            Domicilio_Perfil, Padecimientos_Perfil,
            Medicamentos_Perfil;
    ...
    private void InicializarVariables(){
        ...
        Padecimientos_Perfil = findViewById(R.id.Padecimientos_Perfil);
        Medicamentos_Perfil = findViewById(R.id.Medicamentos_Perfil);
        ...
        Usuarios.child(user.getUid()).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()){
                    ...
                    String padecimientos = ""+snapshot.child("padecimientos").getValue();
                    String medicamentos = ""+snapshot.child("medicamentos").getValue();
                    ...
                    Padecimientos_Perfil.setText(padecimientos);
                    Medicamentos_Perfil.setText(medicamentos);
    ...
    private void ActualizarDatos(){
        ...
        String A_Universidad = Padecimientos_Perfil.getText().toString();
        String A_Profesion = Medicamentos_Perfil.getText().toString();
        ...
        Datos_Actualizar.put("padecimientos", A_Universidad);
        Datos_Actualizar.put("medicamentos", A_Profesion);
